            ...
            BuyButton.Click += (o, e) =>
            {
                ...
                if (UserMode)
                {
                    if (Selected.Listing.ItemType == MarketItemType.Consign)
                    {
                        ...
                        {
                            MirMessageBox box = new MirMessageBox(string.Format(GameLanguage.TrustMerchant_GetBackUnsold, Selected.Listing.Item.FriendlyName), MirMessageBoxButtons.YesNo);
                ...
                else
                {
                    switch (Selected.Listing.ItemType)
                    {
                        ...
                        case MarketItemType.GameShop:
                            {
                                MirMessageBox box = new MirMessageBox(string.Format(GameLanguage.TrustMerchant_BuyConfirm, Selected.Listing.Item.FriendlyName, Selected.Listing.Price, MarketType == MarketPanelType.GameShop ? "Credits" : "Gold"), MirMessageBoxButtons.YesNo);
                                box.YesButton.Click += (o1, e2) =>
                                {
                                    MarketTime = CMain.Time + 3000;
                        ...
                        case MarketItemType.Auction:
                            {
                                ...
                                {
                                    MirMessageBox box = new MirMessageBox(string.Format(GameLanguage.TrustMerchant_BidConfirm, bidAmount.Amount, Selected.Listing.Item.FriendlyName), MirMessageBoxButtons.YesNo);
