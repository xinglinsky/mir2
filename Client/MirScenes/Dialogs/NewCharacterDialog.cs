...
namespace Client.MirScenes.Dialogs
{
    public sealed class NewCharacterDialog : MirImageControl
    {
        ...
        {
            get { return GameLanguage.WarriorsDes; }
        }

        public static string WizardDescription
        {
            get { return GameLanguage.WizardDes; }
        }

        public static string TaoistDescription
        {
            get { return GameLanguage.TaoistDes; }
        }

        public static string AssassinDescription
        {
            get { return GameLanguage.AssassinDes; }
        }

        public static string ArcherDescription
        {
            get { return GameLanguage.ArcherDes; }
        }
