...
namespace Client.MirScenes
{
    public class SelectScene : MirScene
    {
        ...
        private void NewCharacter(S.NewCharacter p)
        {
            ...
            switch (p.Result)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    MirMessageBox.Show(GameLanguage.Character_GenderNotExist);
                    break;
                case 3:
        ...
        private void DeleteCharacter()
        {
            ...
            {
                MirInputBox inputBox = new MirInputBox(GameLanguage.Character_EnterName);
                inputBox.OKButton.Click += (o, e) =>
                {
                    ...
                    {
                        MirMessageBox failedMessage = new MirMessageBox(GameLanguage.Character_IncorrectEntry, MirMessageBoxButtons.OK);
                        failedMessage.Show();
                    }
                    inputBox.Dispose();
                };
        ...
        private void DeleteCharacter(S.DeleteCharacter p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show(GameLanguage.DeleteCharactersDisabled);
                    break;
                case 1:
                    MirMessageBox.Show(GameLanguage.Character_NotExist);
                    break;
            }
        }
        ...
        private void StartGame(S.StartGameDelay p)
        {
            ...
            MirMessageBox message = new MirMessageBox(string.Format(GameLanguage.Character_LoginDelay, Math.Ceiling(p.Milliseconds / 1000M)));

            message.BeforeDraw += (o, e) => message.Label.Text = string.Format(GameLanguage.Character_LoginDelay, Math.Ceiling((time - CMain.Time) / 1000M));
        ...
        public void StartGame(S.StartGame p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show(GameLanguage.StartGame_Disabled);
                    break;
                case 1:
                    MirMessageBox.Show(GameLanguage.StartGame_NotLoggedIn);
                    break;
                case 2:
                    MirMessageBox.Show(GameLanguage.StartGame_CharacterNotFound);
                    break;
                case 3:
                    MirMessageBox.Show(GameLanguage.StartGame_NoMapOrStartPoint);
                    break;
                case 4:
