...
namespace Client.MirScenes
{
    public sealed class GameScene : MirScene
    {
        ...
        public void UseSpell(int key)
        {
                ...
                case Spell.CounterAttack:
                    if ((CMain.Time < magic.CastTime + magic.Delay))
                    {
                        if (CMain.Time >= OutputDelay)
                        {
                            ...
                            Scene.OutputMessage(string.Format(GameLanguage.Skill_CannotCast, magic.Spell.ToString(), ((magic.CastTime + magic.Delay) - CMain.Time - 1) / 1000 + 1));
                        }
            ...
            switch (magic.Spell)
            {
                ...
                case Spell.Thrusting:
                    ...
                    ChatDialog.ReceiveChat(prefix + (actor.Thrusting ? GameLanguage.Skill_UseThrusting : GameLanguage.Skill_DoNotUseThrusting), ChatType.Hint);
        ...
        private void SearchMapResult(S.SearchMapResult info)
        {
            ...
            {
                MirMessageBox messageBox = new MirMessageBox(GameLanguage.System_NothingFound, MirMessageBoxButtons.OK);
        ...
        private void ShareQuest(S.ShareQuest p)
        {
            ...
            MirMessageBox messageBox = new MirMessageBox(string.Format(GameLanguage.Quest_ShareQuestion, p.SharerName), MirMessageBoxButtons.YesNo);
        ...
        private void ReturnToLogin(S.ReturnToLogin p)
        {
            ...
            Dispose();
            MirMessageBox.Show(GameLanguage.System_PersonObservingLoggedOff);
        }
        ...
        private void ObjectItem(S.ObjectItem p)
        {
            ...
            {
                ChatDialog.ReceiveChat(string.Format(GameLanguage.Item_LocationAt, p.Name, p.Location), ChatType.Hint);
            }
            */
        }
                ...
                if (MapControl.Objects.TryGetValue(p.ObjectID, out var obj))
                {
                    ...
                    switch (p.Type)
                    {
                        ...
                        case DamageType.Miss:
                            obj.Damages.Add(new Damage(GameLanguage.Damage_Miss, 1200, obj.Race == ObjectType.Player ? Color.LightCoral : Color.LightGray, 50));
                            break;
                        case DamageType.Critical:
                            obj.Damages.Add(new Damage(GameLanguage.Damage_Crit, 1000, obj.Race == ObjectType.Player ? Color.DarkRed : Color.DarkRed, 50) { Offset = 15 });
                            break;
                    }
                }
            }
        ...
        {
            MirInputBox inputBox = new MirInputBox(GameLanguage.System_PleaseEnterInfo);
        ...
        private void DeleteGroup()
        {
            ...
            ChatDialog.ReceiveChat(GameLanguage.Group_YouLeft, ChatType.Group);
        }
        ...
        private void DeleteMember(S.DeleteMember p)
        {
            ...
            ChatDialog.ReceiveChat(string.Format("-" + GameLanguage.Group_PlayerLeft, p.Name), ChatType.Group);
        }

        private void GroupInvite(S.GroupInvite p)
        {
            MirMessageBox messageBox = new MirMessageBox(string.Format(GameLanguage.Group_InviteQuestion, p.Name), MirMessageBoxButtons.YesNo);
        ...
        private void AddMember(S.AddMember p)
        {
            ...
            ChatDialog.ReceiveChat(string.Format("-" + GameLanguage.Group_PlayerJoined, p.Name), ChatType.Group);
        }
        ...
        {
            MirInputBox inputBox = new MirInputBox(GameLanguage.Guild_CreateEnterName);
        ...
        {
            MirInputBox inputBox = new MirInputBox(GameLanguage.Guild_WarEnterName);
        ...
        private void NewIntelligentCreature(S.NewIntelligentCreature p)
        {
            ...
            MirInputBox inputBox = new MirInputBox(GameLanguage.Creature_EnterName);
        ...
        public MirControl AttackInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false)
        {
            ...
            if (minValue > 0 && realItem.Type == ItemType.Gem)
            {
                ...
                {
                    default:
                        text = string.Format(GameLanguage.Item_AddsDurability, minValue / 1000);
                        break;
                    case 8:
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                if (HoverItem.Info.Type != ItemType.Gem)
                    ...
                    text = string.Format(GameLanguage.Item_AddsAccuracy, minValue + maxValue + addValue);
            ...
            if (minValue != 0 || maxValue != 0 || addValue != 0)
            {
                ...
                if (HoverItem.Info.Type != ItemType.Gem)
                {
                    ...
                    text = string.Format(GameLanguage.Item_AddsASpeed, minValue + maxValue + addValue);
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                if (HoverItem.Info.Type != ItemType.Gem)
                    ...
                    text = string.Format(GameLanguage.Item_AddsFreezing, minValue + maxValue + addValue);
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                if (HoverItem.Info.Type != ItemType.Gem)
                    ...
                    text = string.Format(GameLanguage.Item_AddsPoison, minValue + maxValue + addValue);
        ...
        public MirControl DefenceInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false)
        {
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                if (HoverItem.Info.Type != ItemType.Gem)
                    ...
                    text = string.Format(GameLanguage.Item_AddsAgility, minValue + maxValue + addValue);
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                if (HoverItem.Info.Type != ItemType.Gem)
                    ...
                    text = string.Format(GameLanguage.Item_AddsPoisonResist, minValue + maxValue + addValue);
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                if (HoverItem.Info.Type != ItemType.Gem)
                    ...
                    text = string.Format(GameLanguage.Item_AddsMagicResist, minValue + maxValue + addValue);
        ...
        public MirControl WeightInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            if (minValue > 0 || maxValue > 0 || addValue > 0)
            {
                ...
                MirLabel BAGWEIGHTLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_InstantRun)
                };
        ...
        public MirControl SocketInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            for (int i = 0; i < item.Slots.Length; i++)
            {
                ...
                MirLabel SOCKETLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_Socket, item.Slots[i] == null ? GameLanguage.Item_SocketEmpty : item.Slots[i].FriendlyName)
                };
            ...
            if (count > 0)
            {
                ...
                MirLabel SOCKETLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_SocketOpenHint
                };
        ...
        public MirControl NeedInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            if (realItem.RequiredAmount > 0)
            {
                ...
                switch (realItem.RequiredType)
                {
                    ...
                    case RequiredType.MinSC:
                        ...
                        break;
                    default:
                        text = GameLanguage.System_UnknownTypeRequired;
                        break;
                }
            ...
            if (item.Price() > 0)
            {
                ...
                text = string.Format(GameLanguage.Item_SellingPrice, ((long)(item.Price() / 2)).ToString("###,###,##0"));
        ...
        public MirControl BindInfoLabel(UserItem item, bool Inspect = false, bool hideAdded = false)
        {
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontDeathdrop))
            {
                ...
                MirLabel DONT_DEATH_DROPLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_CantDropOnDeath)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontDrop))
            {
                ...
                MirLabel DONT_DROPLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_CantDrop)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontUpgrade))
            {
                ...
                MirLabel DONT_UPGRADELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_CantUpgrade)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontSell))
            {
                ...
                MirLabel DONT_SELLLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_CantSell)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontTrade))
            {
                ...
                MirLabel DONT_TRADELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_CantTrade)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontStore))
            {
                ...
                MirLabel DONT_STORELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_CantStore)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DontRepair))
            {
                ...
                MirLabel DONT_REPAIRLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_CantRepair)
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.NoSRepair))
            {
                ...
                MirLabel DONT_REPAIRLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_CantSpecialRepair
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.BreakOnDeath))
            {
                ...
                MirLabel DONT_REPAIRLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_BreaksOnDeath
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.DestroyOnDrop))
            {
                ...
                MirLabel DONT_DODLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_DestroyedWhenDropped
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.NoWeddingRing))
            {
                ...
                MirLabel No_WedLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_CannotBeWeddingRing
                };
            ...
            if (HoverItem.Info.Bind != BindMode.None && HoverItem.Info.Bind.HasFlag(BindMode.NoHero))
            {
                ...
                MirLabel No_HeroLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_CannotBeUsedByHero
                };
            ...
            if ((HoverItem.Info.Bind.HasFlag(BindMode.BindOnEquip)) & HoverItem.SoulBoundId == -1)
            {
                ...
                MirLabel BOELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_SoulBindsOnEquip
                };
            ...
            else if (HoverItem.SoulBoundId != -1)
            {
                ...
                MirLabel BOELabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_SoulboundTo, GetUserName((uint)HoverItem.SoulBoundId))
                };
            ...
            if (HoverItem.Info.Type == ItemType.Gem)
            {
                ...
                {
                    Text = GameLanguage.Item_GemCannotUse;
                }
                else
                {
                    Text = GameLanguage.Item_GemCanUseOn;
                }
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Paralize))
                {
                    MirLabel GemWeapon = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnWeapon
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Teleport))
                {
                    MirLabel GemArmour = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnArmour
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.ClearRing))
                {
                    MirLabel Gemhelmet = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnHelmet
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Protection))
                {
                    MirLabel Gemnecklace = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnNecklace
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Revival))
                {
                    MirLabel GemBracelet = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnBracelet
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Muscle))
                {
                    MirLabel GemRing = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnRing
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Flame))
                {
                    MirLabel Gemamulet = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnAmulet
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Healing))
                {
                    MirLabel Gembelt = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnBelt
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Probe))
                {
                    MirLabel Gemboots = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnBoots
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.Skill))
                {
                    MirLabel Gemstone = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnStone
                    };
                ...
                if (HoverItem.Info.Unique.HasFlag(SpecialItemMode.NoDuraLoss))
                {
                    MirLabel Gemtorch = new MirLabel
                    {
                        ...
                        OutLine = true,
                        Parent = ItemLabel,
                        Text = GameLanguage.Item_GemUseOnCandle
                    };
            ...
            if (HoverItem.ExpireInfo != null)
            {
                ...
                MirLabel EXPIRELabel = new MirLabel
                {
                    ...
                    Text = remainingSeconds > 0
                        ? string.Format(GameLanguage.Item_ExpiresIn, Functions.PrintTimeSpanFromSeconds(remainingSeconds))
                        : GameLanguage.Item_Expired
                };
            ...
            if (HoverItem.SealedInfo != null)
            {
                ...
                if (remainingSeconds > 0)
                {
                    ...
                    MirLabel SEALEDLabel = new MirLabel
                    {
                        ...
                        Parent = ItemLabel,
                        Text = remainingSeconds > 0
                            ? string.Format(GameLanguage.Item_SealedFor, Functions.PrintTimeSpanFromSeconds(remainingSeconds))
                            : ""
                    };
            ...
            if (HoverItem.RentalInformation?.RentalLocked == false)
            {
                ...
                MirLabel OWNERLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = string.Format(GameLanguage.Item_RentalFrom, HoverItem.RentalInformation.OwnerName)
                };
                ...
                MirLabel RENTALLabel = new MirLabel
                {
                    ...
                    Text = remainingTime > 0
                        ? string.Format(GameLanguage.Item_RentalExpiresIn, Functions.PrintTimeSpanFromSeconds(remainingTime))
                        : GameLanguage.Item_RentalExpired
                };
            ...
            else if (HoverItem.RentalInformation?.RentalLocked == true && HoverItem.RentalInformation.ExpiryDate > CMain.Now)
            {
                ...
                var RentalLockLabel = new MirLabel
                {
                    ...
                    Parent = ItemLabel,
                    Text = remainingTime > 0
                        ? string.Format(GameLanguage.Item_RentalLockExpiresIn, Functions.PrintTimeSpanFromSeconds(remainingTime))
                        : GameLanguage.Item_RentalLockExpired
                };
        ...
        public MirControl OverlapInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            if (realItem.Type == ItemType.Gem)
            {
                ...
                {
                    case 1:
                        text = GameLanguage.Item_GemHint_RepairPartialWeaponAccessory;
                        break;
                    case 2:
                        text = GameLanguage.Item_GemHint_RepairPartialArmourDrapery;
                        break;
                    case 3:
                        text = GameLanguage.Item_GemHint_CombineMaybeDestroy;
                        break;
                    case 4:
                        text = GameLanguage.Item_GemHint_CombineNoDestroy;
                        break;
                    case 5:
                        text = GameLanguage.Item_GemHint_RepairFullWeaponAccessory;
                        break;
                    case 6:
                        text = GameLanguage.Item_GemHint_RepairFullArmourDrapery;
                        break;
                    case 8:
                        text = GameLanguage.Item_GemHint_SealItem;
                        break;
                }
                count++;
        ...
        public MirControl StoryInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            {
                HoverItem.Info.ToolTip = string.Format(GameLanguage.Item_CreditScroll_AddCredits, HoverItem.Info.Price);
            }
        ...
        public MirControl GMMadeLabel(UserItem item)
        {
            if (item.GMMade)
            {
                ...
                MirLabel GMLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = ItemLabel,
                    Text = GameLanguage.Item_CreatedByGameMaster
                };
        ...
        public void CreateMailLabel(ClientMail mail)
        {
            ...
            if (mail.Gold > 0)
            {
                MirLabel goldLabel = new MirLabel
                {
                    ...
                    OutLine = true,
                    Parent = MailLabel,
                    Text = string.Format(GameLanguage.Mail_GoldLabel, mail.Gold)
                };
    ...
    public sealed class MapControl : MirControl
    {
                    ...
                    (!MapObject.TargetObject.Name.EndsWith(")") && MapObject.TargetObject is MonsterObject))
                {
                    ...
                    if (User.Class == MirClass.Archer && User.HasClassWeapon && !User.RidingMount && !User.Fishing)//ArcherTest - non aggressive targets (player / pets)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                OutputDelay = CMain.Time + 1000;
                                GameScene.Scene.OutputMessage(GameLanguage.System_TargetTooFar);
                            }
                        }
                        //  return;
                    }
        ...
        public void UseMagic(ClientMagic magic, UserObject actor)
        {
            ...
            if ((CMain.Time <= magic.CastTime + magic.Delay))
            {
                ...
                {
                    OutputDelay = CMain.Time + 1000;
                    GameScene.Scene.OutputMessage(string.Format(GameLanguage.Skill_CannotCast, magic.Spell.ToString(), ((magic.CastTime + magic.Delay) - CMain.Time - 1) / 1000 + 1));
                }
